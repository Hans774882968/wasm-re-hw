...
mod tests {
    ...
    #[test]
    fn decrypt_to_username_with_spaces_test() -> Result<(), String> {
        let result1 = decrypt_to_username("\t  KQAZOSRTAgMa  \n \t  ")?;
        assert_eq!(result1, "Acm_L0ver");
        let result2 = decrypt_to_username("   AAAAAA==\n\t   ")?;
        assert_eq!(result2, "hctf");
